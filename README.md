...
- **Generación de menú con IA** (Google Gemini; modelo configurable en el servidor, `gemini-3.5-flash` por defecto con fallback automático) ajustada a tus objetivos calóricos y de macros.
